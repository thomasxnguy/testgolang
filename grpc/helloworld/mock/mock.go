...
import (
	...
	helloworld "github.com/thomasxnguy/testgolang/grpc/helloworld"
)
...
func (_m *MockGreeterClient) SayHello2(_param0 context.Context, _param1 *helloworld.HelloRequest2, _param2 ...grpc.CallOption) (*helloworld.HelloReply, error) {
	_s := []interface{}{_param0, _param1}
	for _, _x := range _param2 {
		_s = append(_s, _x)
	}
...
func (_m *MockGreeterClient) SayHello3(_param0 context.Context, _param1 *helloworld.HelloRequest3, _param2 ...grpc.CallOption) (*helloworld.HelloReply, error) {
	_s := []interface{}{_param0, _param1}
	for _, _x := range _param2 {
		_s = append(_s, _x)
	}
