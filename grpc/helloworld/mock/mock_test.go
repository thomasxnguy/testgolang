...
func TestSayHello(t *testing.T) {
	...
	req := &helloworld.HelloRequest{Avatar: &helloworld.HelloRequest_Name{Name:"unit_test"}}
...
func testSayHello(t *testing.T, client helloworld.GreeterClient) {
	...
	defer cancel()
	r, err := client.SayHello(ctx, &helloworld.HelloRequest{Avatar: &helloworld.HelloRequest_Name{Name:"unit_test"}})
